    ...
    <main className={styles.main}>
      ...
      <div className={styles.container}>
        ...
        <h1 className={styles.title}>
          <span className={styles.darkText}>Page </span>
          <span className={styles.coralText}>Not Found</span>
        </h1>
        ...
        <p className={styles.subtitle}>
          Oops! It looks like this little joy got lost.<br/>
          ...
          <Link href="/">
            <button className={styles.primaryBtn}>
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" strokeLinecap="round" strokeLinejoin="round"/><polyline points="9 22 9 12 15 12 15 22" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </button>
          </Link>
        </div>
