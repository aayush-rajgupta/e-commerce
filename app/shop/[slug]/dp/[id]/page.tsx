...
// ---------------------------------------------------------------------------
// Mock data — replace with a real fetch(id) call when the API is ready.
// The `slug` param in the URL is for SEO only and is intentionally ignored here.
// ---------------------------------------------------------------------------
const MOCK_PRODUCT = {
  id: "p1",
  ...
  price: 120.0,
  description:
    "This exquisite ceramic vase is handcrafted by skilled artisans. Featuring a matte off-white finish with subtle terracotta speckles, it brings a warm, minimalist aesthetic to any room. Perfect for dried florals or standing elegantly on its own.",
  images: [
...
export default function ProductDetailPage() {
  // `slug` is present in the URL for SEO purposes but is intentionally unused.
  // Only `id` is used to identify and fetch the correct product.
  ...
  // TODO: Replace MOCK_PRODUCT with a real lookup by `id` once the API exists.
  ...
  return (
    <main className="relative w-full min-h-screen bg-brand-bg selection:bg-brand-coral selection:text-white pb-20">
          ...
          <div className="w-full lg:w-1/2 flex flex-col pt-2 lg:pt-10">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <div className="flex items-center gap-5 mb-8">
                <span className="text-2xl font-bold text-brand-dark tracking-tight">${product.price.toFixed(2)}</span>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
            <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-brand-dark/50 font-medium">Based on {product.reviewsCount} reviews</span>
              </div>
            </div>
